...
import { BuyCategoriesSubPage } from "../buy-categories-sub/buy-categories-sub";

import { SearchPage } from "../../pages/search/search";


@Component({
  selector: 'page-buy-categories',
  templateUrl: 'buy-categories.html',
  animations: [
    trigger('cartBadge', [
        state('idle', style({
            opacity: '1',
...
export class BuyCategoriesPage {
  ...
  ionViewDidEnter(){
    ...
    click_Open_catalogue_id(id,name_ar,name_en){
      ...
      this.navCtrl.push(BuyCategoriesSubPage, {
        'id' : id,
        'name' : name
      });  
