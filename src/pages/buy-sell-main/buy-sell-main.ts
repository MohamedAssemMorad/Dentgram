...
import { BuyCategoriesPage } from "../buy-categories/buy-categories";

import { CatalogueMainPage } from "../catalogue-main/catalogue-main";
...
@Component({
  selector: 'page-buy-sell-main',
  templateUrl: 'buy-sell-main.html',
  animations: [
    trigger('cartBadge', [
        state('idle', style({
            opacity: '1',
...
export class BuySellMainPage {
  ...
  ionViewDidEnter(){
    ...
    click_Open_categories(){
      this.navCtrl.push(CatalogueMainPage, {
        'title': '',
        'secretid': 'for_store'
      });  
    }
