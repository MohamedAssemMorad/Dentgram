...
@Component({
  selector: 'page-used-ads-sub-menu',
  templateUrl: 'used-ads-sub-menu.html',
  animations: [
    trigger('cartBadge', [
        state('idle', style({
            opacity: '1',
...
export class UsedAdsSubMenuPage {
  ...
  ionViewDidEnter(){
    ...
    ionViewDidLoad(){
      ...
      console.log('ionViewDidLoad UsedAdsSubMenuPage');
      this.viewCtrl.setBackButtonText('');
    ...
    click_Open_catalogue_sub_id(id,name_ar,name_en,useable){
      ...
      if (useable === false){
        ...
        }else if (this.secretid === 'for_used'){
